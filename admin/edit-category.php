...
if(isset($_POST['submit']))
  ...
  $query = mysqli_query($con, "UPDATE tblcategory SET VehicleCat='$catname', `limit`=$limit_value WHERE ID='$eid'");
    if ($query) {
...
<div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Limit</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="limit_value" name="limit_value" class="form-control" placeholder="NO of slots" required="true"></div>
                                    </div>
