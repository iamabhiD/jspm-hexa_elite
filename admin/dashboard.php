...
$count_today_vehentries=mysqli_num_rows($query);
 ?>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <?php
                        //total free slots 
                        $query=mysqli_query($con,"select ID from tblvehicle where `Status`='';");
                        $count_booked_slots=mysqli_num_rows($query);
                        ?>
                        <div class="card">
                             <div class="card-body">
                                 <div class="stat-widget-five">
                                     ...
                                     <div class="stat-content">
                                         <div class="text-left dib">
                                             <div class="stat-text"><span class="count"><?php echo $count_booked_slots?></span></div>
                                             <div class="stat-heading">Booked Slots</div>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                     ...
                     <div class="col-lg-3 col-md-6">
 <?php
                        $query = mysqli_query($con, "SELECT SUM(`limit`) AS TotalLimit FROM `tblcategory`");
                         // Fetch the result 
                         $row = mysqli_fetch_assoc($query); // Store the result in a variable 
                         $lim = $row['TotalLimit'];
                         $free_slot=$lim-$count_booked_slots;
  ?>
                        <div class="card">
                             <div class="card-body">
                                 <div class="stat-widget-five">
                                     ...
                                     <div class="stat-content">
                                         <div class="text-left dib">
                                             <div class="stat-text"><span class="count"><?php echo $free_slot?></span></div>
                                             <div class="stat-heading">Free Slots</div>
                                         </div>
                                     </div>
                                 </div>
                             </div>
...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header" style="color: red;" >
            <strong class="card-title"> Vehicle Parked More Than 10 hours</strong>
        </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                        ...
                        <?php
                        $query2 = mysqli_query($con, "SELECT ID, ParkingNumber, OwnerName, RegistrationNumber 
                                                    FROM tblvehicle 
                                                    WHERE TIMESTAMPDIFF(HOUR, InTime, NOW()) > 10 
                                                    AND OutTime IS NULL;");
