...
// Example in time (format: Y-m-d H:i:s)
$in_time = $row['InTime'];
...
$interval = $in_time_obj->diff($current_time_obj);
$hours = $interval->h + ($interval->days * 24); // Total hours including days

// Calculate parking charges (₹5 per hour)
$parking_charges = max(5, $hours * 5);
?>

    <div class="stat-icon dib flat-color-3">
        IN TIME: <?php echo $in_time; ?>
        
    </div>
    <div>
        <label for="parkingcharge">Parking Charges:</label>
        <input type="text" name="parkingcharge" id="parkingcharge" value="<?php echo $parking_charges; ?>" class="form-control">
    </div>
